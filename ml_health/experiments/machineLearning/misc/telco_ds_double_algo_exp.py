...
periodic_load_path = '/data-lake/ml-prototypes/classification/ml/realm-im2015-vod-traces/X_SAR/periodic_load/'

# flashcrowd_load is the path to the second Dataset in time
flashcrowd_load_path = '/data-lake/ml-prototypes/classification/ml/realm-im2015-vod-traces/X_SAR/flashcrowd_load/'

# linear_increase is the path to the second Dataset in time
linear_increase_path = '/data-lake/ml-prototypes/classification/ml/realm-im2015-vod-traces/X_SAR/linear_increase/'

# constant_load is the path to the second Dataset in time
constant_load_path = '/data-lake/ml-prototypes/classification/ml/realm-im2015-vod-traces/X_SAR/constant_load/'

# poisson_load is the path to the second Dataset in time
poisson_load_path = '/data-lake/ml-prototypes/classification/ml/realm-im2015-vod-traces/X_SAR/poisson_load/'
...
def generate_dataset(all_paths):
...
# generate_dataset(all_paths=all_path)

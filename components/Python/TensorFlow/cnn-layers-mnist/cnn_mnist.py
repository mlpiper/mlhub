...
def add_parameters(parser):
    ...
    parser.add_argument("--iterations", dest="iterations", type=int, required=False, default=1000, help='Number of training iterations')
...
def main(args):
    ...
    print("Training seconds: {}. Total seconds: {}".format(training_elapsed_time, prog_elapsed_time))

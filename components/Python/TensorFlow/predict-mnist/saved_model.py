...
class SavedModel(Model):
    def __init__(self, output_file, model_dir, signature_def, stats_interval, stats_type, conf_thresh, conf_percent):
        ...
        self._stats = CategoricalStatistics(stats_interval, stats_type, num_categories, conf_thresh, conf_percent)
